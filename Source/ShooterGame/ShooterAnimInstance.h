...
private:
	...
	// Yaw of the Character this frame; Only udated when standing still and not in air
	float TIPCharacterYaw;

	// Yaw of the Character the previous frame; Only udated when standing still and not in air
