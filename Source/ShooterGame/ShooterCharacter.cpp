...
{
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds()); // deg/sex * sec/frame
}
...
void AShooterCharacter::CalculateCrosshairSpread(float DeltaTime)
{
	...
	// Calculate corsshair in air factor
...
void AShooterCharacter::PlayGunfireMontage()
{
	...
	if (AnimInstance && HipFireMontage)  // Check if it is valid
	{
...
void AShooterCharacter::FinishReloading()
{
	...
	{
		// Amount of ammo the Character is carrying o fthe EquippedWeapon type
