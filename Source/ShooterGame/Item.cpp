...
void AItem::BeginPlay()
{
	...
	// Hide widget beginning of the game
	if (PickupWidget)
	{
...
void AItem::ItemInterp(float DeltaTime)
{
	...
	if (Character && ItemZCurve)
	{
		...
		// Set X and Y of ItemLocatşon to Interped values
...
void AItem::OnConstruction(const FTransform& Transform)
{
	...
	FString RarityTablePath(TEXT("DataTable'/Game/Main/DataTables/ItemRarityDataTable.ItemRarityDataTable'"));
	...
	if (RarityTableObject)
	{
		...
		{
			case EItemRarity::EIR_Damaged:
				RarityRow = RarityTableObject->FindRow<FItemRarityTable>(FName("Damage"), TEXT(""));
			break;
			case EItemRarity::EIR_Common:
